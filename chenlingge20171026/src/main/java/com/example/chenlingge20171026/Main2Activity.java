...
import com.example.chenlingge20171026.adapter.CartAdapter;
 ...
 * 类的日期：2017.10.26
 */
public class Main2Activity extends AppCompatActivity implements CartAdapter.RefreshPriceInterface, View.OnClickListener {
    ...
    private void initDate() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            adapter = new CartAdapter(Main2Activity.this, goodsList);
            adapter.setRefreshPriceInterface(Main2Activity.this);
